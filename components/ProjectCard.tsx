...
function ProjectCard({ project }: { project: Project }) {
  return (
    <div className='group/card flex flex-col h-full border-2 hover:border-muted-foreground rounded-xl overflow-hidden bg-white dark:bg-[#05070a] transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-black/10'>
